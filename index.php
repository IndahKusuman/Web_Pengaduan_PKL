...
<head>
    ...
    <title>PENGADUAN PKL KOTA SURAKARTA</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-md-6 ">
                         <li><a href="https://pkl_surakarta.gis.co.id/" style="color:white"><i class="fa fa-podcast"> PETA PESEBARAN PKL KOTA</i></a></li>
                        </div>
                        <div class="col-xl-6 col-md-6">
                            <div class="short_contact_list">
                                <ul>
                                    <li><a href="#"> <i class="fa fa-envelope"></i> satpol-pp@surakarta.com</a></li>
                                    <li><a href="#"> <i class="fa fa-phone"></i>0271-656623</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-12">
                            <div class="slider_text">
                                ...
                                <p>Selamat datang di web Pengaduan PKL Kota Surakarta<br>
                                    Silahkan Registrasi atau Login dengan akun anda.</p>
                                <div class="video_service_btn">
                                    <a href="registrasi.php" class="boxed-btn3"><i class="fa fa-user-plus"> Registrasi </i></a>
