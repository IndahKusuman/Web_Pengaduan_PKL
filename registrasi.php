...
if (isset($_POST['simpan'])){
	...
	$user = $_POST ['user'];
	$pass = $_POST ['pass'];
	$tambah = mysqli_query ($conn, "INSERT INTO masyarakat(nik,nama,alamat,kecamatan,tlp,username,password)VALUES('$nik','$nama','$alamat','$kecamatan','$tlp','$user','$pass')");
	if($tambah){
...
<tr>
<td><h7>KECAMATAN</h7></th><td><input type="text" name="kecamatan" class="form_input2" required="required" placeholder="KECAMATAN"></td>
</tr>
<tr>
